...
eval::evaluator<char, T> create_real_eval() {
  ...
  func<T> mod_op{2, 2,
                 [](const T *args) { return std::fmod(args[0], args[1]); }};
  ...
  func<T> lg_op{1, size_max, [](const T *args) { return std::log10(args[0]); }};
  func<T> ln_op{1, size_max, [](const T *args) { return std::log(args[0]); }};
  func<T> log2_op{1, size_max,
                  [](const T *args) { return std::log2(args[0]); }};
